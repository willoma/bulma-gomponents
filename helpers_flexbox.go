...
var flexbox = c.NewPage(
	...
	c.Table(
		b.HeadRow("Modifier", "Property: Value"),
		c.Row("b.FlexGrow0", e.Code("flex-grow: 0")),
		c.Row("b.FlexGrow1", e.Code("flex-grow: 1")),
		c.Row("b.FlexGrow2", e.Code("flex-grow: 2")),
		c.Row("b.FlexGrow3", e.Code("flex-grow: 3")),
		c.Row("b.FlexGrow4", e.Code("flex-grow: 4")),
		c.Row("b.FlexGrow5", e.Code("flex-grow: 5")),
		c.Row("b.FlexShrink0", e.Code("flex-shrink: 0")),
		c.Row("b.FlexShrink1", e.Code("flex-shrink: 1")),
		c.Row("b.FlexShrink2", e.Code("flex-shrink: 2")),
		c.Row("b.FlexShrink3", e.Code("flex-shrink: 3")),
		c.Row("b.FlexShrink4", e.Code("flex-shrink: 4")),
		c.Row("b.FlexShrink5", e.Code("flex-shrink: 5")),
	),
)
