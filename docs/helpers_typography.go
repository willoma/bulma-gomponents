...
el.P(b.TextRight, "Right")`,
	...
	c.Example(
		`b.Table(
	b.HeadRow("Modifier", "Transformation"),
	b.Row(el.Code("b.WeightLight"), el.P(b.WeightLight, "Transform weight to light")),
	b.Row(el.Code("b.WeightNormal"), el.P(b.WeightNormal, "Transform weight to normal")),
	b.Row(el.Code("b.WeightMedium"), el.P(b.WeightMedium, "Transform weight to medium")),
	...
	b.Row(el.Code("b.Bold"), el.P(b.Bold, "Transform weight to bold")),
		...
		b.Table(
			...
			b.Row(el.Code("b.WeightNormal"), el.P(b.WeightNormal, "Transform weight to normal")),
			b.Row(el.Code("b.WeightMedium"), el.P(b.WeightMedium, "Transform weight to medium")),
			b.Row(el.Code("b.WeightSemiBold"), el.P(b.WeightSemiBold, "Transform weight to semi-bold")),
			b.Row(el.Code("b.WeightBold"), el.P(b.WeightBold, "Transform weight to bold")),
		),
	),
).Section(
	"Font family",
	...
	b.Row(el.Code("b.FamilyPrimary"), el.P(b.FamilyPrimary, "Set font family to primary")),
	b.Row(el.Code("b.FamilySecondary"), el.P(b.FamilySecondary, "Set font family to secondary")),
