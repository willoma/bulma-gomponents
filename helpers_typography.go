...
var typography = c.NewPage(
	...
	c.Table(
		...
		c.Row("b.FontSize1", e.Span(b.FontSize1, "Set font size to 1"), " (3 rem)"),
		c.Row("b.FontSize2", e.Span(b.FontSize2, "Set font size to 2"), " (2.5 rem)"),
		c.Row("b.FontSize3", e.Span(b.FontSize3, "Set font size to 3"), " (2 rem)"),
		c.Row("b.FontSize4", e.Span(b.FontSize4, "Set font size to 4"), " (1.5 rem)"),
		c.Row("b.FontSize5", e.Span(b.FontSize5, "Set font size to 5"), " (1.25 rem)"),
		c.Row("b.FontSize6", e.Span(b.FontSize6, "Set font size to 6 (default size)"), " (1 rem)"),
		c.Row("b.FontSize7", e.Span(b.FontSize7, "Set font size to 7"), " (0.75 rem)"),
	),
).Section(
	"Responsive size",
